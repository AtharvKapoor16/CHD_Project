...
EPOCHS = 10
LEARNING_RATE = 0.001
MODEL_PATH = "echocardiogram_model_3.pth"
...
for epoch in range(EPOCHS):
    ...
    train_loader_tqdm = tqdm(train_loader, desc="Training", leave=False, colour="green")
    ...
    val_loader_tqdm = tqdm(val_loader, desc="Validation", leave=False, colour="green")
    with torch.no_grad():
        for inputs, targets in val_loader_tqdm:
            ...
            val_loader_tqdm.set_postfix({"Loss": f"{val_loss / len(val_loader):.4f}"})
