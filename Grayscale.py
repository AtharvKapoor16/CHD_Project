...
# Example usage
parent_folder = "Folder/Subfolder"  # Replace with the path to your main folder containing subfolders
output_parent_folder = "Grayscale_Folder/Subfolder"  # Replace with the path where grayscale images will be saved
